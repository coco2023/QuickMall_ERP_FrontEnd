...
import { InventoryService } from 'app/modules/admin/ecommerce/product/product.service';
import { InventoryBrand, InventoryCategory, InventoryPagination, InventoryProduct, InventoryTag, InventoryVendor } from 'app/modules/admin/ecommerce/product/product.types';

@Injectable({
    providedIn: 'root'
})
export class CustomerBrandsResolver implements Resolve<any>
{
    /**
     * Constructor
     */
